...
output_path = f"/root/autodl-tmp/output_{selected_model.split('/')[-1]}_seed0"
router_path = f"/root/autodl-tmp/output_{selected_model.split('/')[-1]}_seed42_ori"

test_pd = pd.read_parquet(f"/root/autodl-tmp/data/test_cwe.parquet")
train_pd = pd.read_parquet(f"/root/autodl-tmp/data/train_cwe.parquet")
val_pd = pd.read_parquet(f"/root/autodl-tmp/data/val_cwe.parquet")
